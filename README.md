...
9. **Commit all the changes (Write commit message as "Small Message"):**
...
11. **Open a Pull Request:** Create a pull request from your fork to this repository. Provide a concise title and description.
